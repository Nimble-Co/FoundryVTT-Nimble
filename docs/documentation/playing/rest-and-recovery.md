...
<!-- TODO(screenshot): the field rest window showing the Catch Breath / Make Camp cards and the hit dice spend rows -->
...
<!-- TODO(screenshot): the safe rest window showing the recovery preview cards -->
