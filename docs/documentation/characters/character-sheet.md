...
<!-- TODO(screenshot): the full character sheet with the header, tab bar, and sidebar buttons visible -->
...
<!-- TODO(screenshot): the spells tab with the school filter and a spell card visible -->
