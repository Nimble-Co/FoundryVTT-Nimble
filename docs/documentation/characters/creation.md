...
5. **Ancestry options** *(only for some ancestries)*. If your ancestry covers more than one kind of people — Dryad/Shroomling, Minotaur/Beastfolk, Oozeling/Construct — pick which one you are. They play identically; your sheet takes the name you choose. If your ancestry comes in more than one size, pick one of those too. A few ancestries also let you choose a saving throw to be good at.
