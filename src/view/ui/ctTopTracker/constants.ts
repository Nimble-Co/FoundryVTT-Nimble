...
export const ACTION_DICE_ICON_CLASSES = [
	'fa-solid fa-dice-one',
	'fa-solid fa-dice-two',
	'fa-solid fa-dice-three',
] as const;

export const MAX_RENDERED_ACTION_DICE = ACTION_DICE_ICON_CLASSES.length;
...
export const CT_MAX_WIDTH_LEVEL = 6;
export const CT_MIN_CARD_SIZE_LEVEL = 1;
export const CT_MAX_CARD_SIZE_LEVEL = 6;
export const CT_MIN_BADGE_SIZE_LEVEL = 1;
export const CT_MAX_BADGE_SIZE_LEVEL = 6;
...
export const CT_BADGE_SCALE_STEP =
