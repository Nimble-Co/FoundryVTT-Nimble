...
function _getOptionalRulesSettings() {
	return optionalRulesSettings
...
<div class="system-settings-dialog">
	<h2>{game.i18n.localize('NIMBLE.settings.optionalRulesMenu.name')}</h2>

	<form class="settings-list">
		<div class="category-section">
			{#each _getOptionalRulesSettings() as setting}
