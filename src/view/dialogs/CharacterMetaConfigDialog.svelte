<script>
	...
	let currentSize = $derived(actor.reactive.system.attributes.sizeCategory ?? 'medium');
...
<section class="nimble-sheet__body nimble-sheet__body--item">
	<label class="nimble-details-field nimble-details-field--column" style="grid-area: size;">
		<span
