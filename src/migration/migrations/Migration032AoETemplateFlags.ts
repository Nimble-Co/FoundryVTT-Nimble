 ...
 */
class Migration032AoETemplateFlags extends MigrationBase {
	static override readonly version = 32;

	override readonly version = Migration032AoETemplateFlags.version;
...
export { Migration032AoETemplateFlags };
