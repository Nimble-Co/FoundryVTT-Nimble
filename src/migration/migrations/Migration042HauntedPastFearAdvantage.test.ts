...
import { Migration042HauntedPastFearAdvantage } from './Migration042HauntedPastFearAdvantage.js';
...
describe('Migration042HauntedPastFearAdvantage', () => {
	const migration = new Migration042HauntedPastFearAdvantage();
