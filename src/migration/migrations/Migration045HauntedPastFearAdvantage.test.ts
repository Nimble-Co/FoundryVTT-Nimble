...
import { Migration045HauntedPastFearAdvantage } from './Migration045HauntedPastFearAdvantage.js';
...
describe('Migration045HauntedPastFearAdvantage', () => {
	const migration = new Migration045HauntedPastFearAdvantage();
