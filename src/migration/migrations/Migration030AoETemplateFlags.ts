 ...
 */
class Migration030AoETemplateFlags extends MigrationBase {
	static override readonly version = 30;

	override readonly version = Migration030AoETemplateFlags.version;
...
export { Migration030AoETemplateFlags };
