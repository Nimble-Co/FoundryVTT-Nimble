 ...
 */
class Migration026CombatDiceMaxFormula extends MigrationBase {
	static override readonly version = 26;

	override readonly version = Migration026CombatDiceMaxFormula.version;
...
export { Migration026CombatDiceMaxFormula };
