...
/**
 * Whether the skills one rule reads take in every skill another reads. The
 ...
 * gains it, a roll mode by the skills it reads and the direction it bends, and
 * an unarmed damage formula by the formula it sets.
 */
...
abstract class ChecklistMigrationBase extends MigrationBase {
	...
	#matchFeature(source: any): FeatureSpec | undefined {
		...
		if (source.system?.class !== this.classIdentifier) return undefined;
