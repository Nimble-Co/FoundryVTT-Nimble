...
**Rationale:** The codebase at `D:/Git/nimble-dev/dev-clean/` has 146 closed issues, established conventions, and a documented style guide. Architectural decisions build on this existing foundation rather than selecting a new one.
